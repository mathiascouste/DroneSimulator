...
class TemplateVector
{
	...
	TemplateVector operator* (const float a) const; 
	TemplateVector operator- (const TemplateVector &A) const; 
...
template<class T>
TemplateVector<T> TemplateVector<T>::operator* (const float f) const
{
	return TemplateVector<T> (m_x * f, m_y * f, m_z * f, m_w * f);
}
